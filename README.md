...
## Декораторы
1. Создали декоратор, который будет определять куда будут записываться логи: в файл или будет выводиться в консоль
2. Создали декоратор, который логирует начало и конец выполнения функции
3.  Задали алгоритм действий чтобы функция не падала при наличии ошибок
